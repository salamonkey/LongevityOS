...
- provider: openai
- model: gpt-5.4
- started_utc: 2026-05-05T18:00:47.509Z
- prompt_chars: 99914
- prompt_estimated_tokens: 24979
- prompt_sources:
...
export default function SelfOnboardingToFirstDashboard({
  ...
  return (
    <AppShell title="Build your first preventive plan">
      ...
      <form className="sl001-form" onSubmit={handleSubmit} noValida
[truncated]
```
## src/features/self-onboarding-to-first-dashboard/catalog.js
```text
...
export const MVP_PREVENTIVE_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    ruleBands: [
      { gender: 'female', minAge: 50, maxAge: 120, targetAge: 50, dashboardB
[truncated]
```
