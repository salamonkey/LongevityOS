...
- provider: openai
- model: gpt-5.4
- started_utc: 2026-05-05T08:53:49.064Z
- prompt_chars: 23283
- prompt_estimated_tokens: 5821
- prompt_sources:
  - team/architect.md
...
```json
{
  ...
  "done_definition": [
    "Plan views cover both checkups and vaccinations for the self profile",
    "Dashboard, plan list, and detail views show consistent item names and status labels",
    "Content review is complete for all MVP preventive items included in the locked item set",
    "docs/testing/SL-002-user-checklist.md is completed and marked Pass for SL-002.",
    "Implementation artifacts exist for SL-002 targets: src/features/health-plan-browsing-and-item-detail/, src/routes/health-plan-browsing-and-item-detail*, tests/health-plan-browsing-and-item-detail/.",
