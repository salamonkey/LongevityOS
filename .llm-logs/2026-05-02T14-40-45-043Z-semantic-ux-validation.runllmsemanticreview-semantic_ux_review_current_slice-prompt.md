...
- provider: openai
- model: gpt-5.4
- started_utc: 2026-05-02T14:40:45.043Z
- prompt_chars: 55995
- prompt_estimated_tokens: 13999
- prompt_sources:
    ...
    return (
      <main className="app-shell">
        ...
        <section className="panel score-card" aria-label="Read-only health score">
          ...
          <p className="helper">
            This score comes only from the generated age and gender rules for this profile.
          </p>
        </section>
      ...
      <section className="panel detail-panel">
        {!activeItem ? (
          <>
            ...
            <h1 className="detail-title">Health item details</h1>
            <div className="inline-error" role="status">
              <p>We couldn&apos;t load this health item right now.</p>
            </div>
            <div className="actions">
              <button
                type="button"
          ...
          <>
            ...
            <section className="detail-block" aria-label="Action">
              <h2>Action</h2>
              <p>{toDisplayText(activeItem.actionLabel, 'Action details are not available yet.')}</p>
            </section>

            <section className="detail-block" aria-label="Recommendation frequency">
              <h2>Recommendation frequency</h2>
              <p>{toDisplayText(activeItem.recommendationFrequency, 'Timing is being prepared.')}</p>
            </section>
            ...
            <section className="detail-block" aria-label="Stat
[truncated]
```
## src/features/health-item-detail-and-completion/healthItemsModel.js
```text
