...
- task: project_brief_targeted_repair
- caller: brief-repair.generateProjectBriefStructuredTargetedRepair
- provider: openai
- model: gpt-5.4
- started_utc: 2026-05-05T07:41:51.495Z
- prompt_chars: 45617
- prompt_estimated_tokens: 11405
- prompt_sources:
...
```json
{
  ...
  "core_mvp_scope": [
    ...
    {
      "title": "Personal health plan and dashboard",
      "bullets": [
        "Generate a rule-based personal health plan immediately after onboarding from a fixed MVP rule table keyed to age and gender.",
        "Display prioritized actions in 'Now', 'Soon', and 'Later' buckets on the dashboard; limit prioritization to internal timing rules.",
        "Show a simple health score per profile as the percentage of plan items currently up to date; exclude predictive or comparative analytics."
    ...
    {
      "title": "Health item detail and actioning",
      "bullets": [
        "List health plan items with status and recommended cadence; use the MVP statuses done, due, and planned.",
        "Show item detail with description, why-it-matters explanation, recommendation cadence, and current status context; exclude clinician advice.",
        "Allow users to mark an item as done from item detail and reflect the update in the plan and dashboard state."
    ...
    {
      "title": "Family mode and settings",
      "bullets": [
        "Show a family overview with one summary row per profile, including health score and due-state highlights.",
        "Let users switch between profiles to view profile-specific dashboard, plan, and vaccination data.",
        "Provide a basic settings area for family management and product preferences; exclude advanced account administration."
  ...
  "primary_user_journey": [
    "User starts onboarding and enters age and gender for the first profile.",
    "User chooses self-only setup or adds family profiles.",
    "Product generates the first profile's health plan immediately after onboarding.",
    "User lands on the dashboard and sees health score plus 'Now / Soon / Later' priorities.",
    "User opens a health item to read what it is, why it matters, and what action to take.",
    "User marks the item done or sets a reminder.",
    "User reviews family profiles and vaccination status as needed.",
    "User returns later to continue acting on due items."
  ],
  "technical_direction": [
    "Build the MVP as a responsive web application to fit the 4–8 week delivery target.",
    "Use a simple authenticated backend with modular entities for accounts, profiles, plan items, reminders, and vaccinations.",
...
[
  {
    "path": "core_mvp_scope[5].bullets[2]",
    "section": "6. Core MVP Scope / Family mode and settings",
    "current_text": "Provide a basic settings area for family management and product preferences; exclude advanced account administration.",
    "findings": [
      {
  ...
  {
    "path": "core_mvp_scope[1].bullets[1]",
    "section": "6. Core MVP Scope / Personal health plan and dashboard",
    "current_text": "Display prioritized actions in 'Now', 'Soon', and 'Later' buckets on the dashboard; limit prioritization to internal timing rules.",
    "findings": [
      {
  ...
  {
    "path": "product_description[0]",
    "section": "1. Product Description",
    "current_text": "Longevity Health OS is a responsive web MVP for preventive health navigation.",
    "findings": [
      {
  ...
  {
    "path": "core_mvp_scope[1].bullets[2]",
    "section": "6. Core MVP Scope / Personal health plan and dashboard",
    "current_text": "Show a simple health score per profile as the percentage of plan items currently up to date; exclude predictive or comparative analytics.",
    "findings": [
      {
        "rule": "source_overreach",
  ...
  {
    "path": "ux_principles_and_tone[2]",
    "section": "7. UX Principles and Tone",
    "current_text": "Use German as the initial launch language across core screens and system copy.",
    "findings": [
      {
        "rule": "source_overreach",
  ...
  {
    "path": "technical_direction[0]",
    "section": "9. Technical Direction",
    "current_text": "Build the MVP as a responsive web application to fit the 4–8 week delivery target.",
    "findings": [
      {
        "rule": "source_overreach",
  ...
  {
    "path": "technical_direction[1]",
    "section": "9. Technical Direction",
    "current_text": "Use a simple authenticated backend with modular entities for accounts, profiles, plan items, reminders, and vaccinations.",
    "findings": [
      {
        "rule": "ambiguous_term",
  ...
  {
    "path": "data_and_privacy_constraints[1]",
    "section": "10. Data and Privacy Constraints",
    "current_text": "Use secure authenticated access and secure storage for all profile data.",
    "findings": [
      {
        "rule": "ambiguous_term",
