...
- provider: openai
- model: gpt-5.4
- started_utc: 2026-05-05T15:30:22.819Z
- prompt_chars: 23389
- prompt_estimated_tokens: 5848
- prompt_sources:
  - team/architect.md
...
```json
{
  ...
  "done_definition": [
    "Profile switching preserves the correct person context across dashboard, plan, and vaccination screens",
    "Family overview summaries match the underlying profile-level item statuses",
    "End-to-end walkthroughs pass for one self profile plus at least one added family member",
    "docs/testing/SL-005-user-checklist.md is completed and marked Pass for SL-005.",
    "Implementation artifacts exist for SL-005 targets: src/features/onboarding/, src/features/profile/, src/routes/onboarding*, tests/onboarding/.",
    "docs/implementation/SL-005-implementation-notes.md is updated with verification evidence and changed files for SL-005.",
