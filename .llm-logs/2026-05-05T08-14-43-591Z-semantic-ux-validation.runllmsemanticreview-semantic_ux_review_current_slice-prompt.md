...
- provider: openai
- model: gpt-5.4
- started_utc: 2026-05-05T08:14:43.591Z
- prompt_chars: 58052
- prompt_estimated_tokens: 14513
- prompt_sources:
  ...
  return (
    <AppShell title="Build your first preventive plan">
      ...
      <form className="sl001-form" onSubmit={handleSubmit} noValidate>
        ...
        <fieldset ref={genderRef} aria-describedby="sl001-gender-error" className="
[truncated]
```
## src/features/self-onboarding-to-first-dashboard/catalog.js
```text
    ...
    <section className="sl001-score-card" aria-label="Health summary">
      <div>
        ...
        <p className="sl001-score-summary">
          Your score reflects how many upcoming items are already planned.
        </p>
      </div>
