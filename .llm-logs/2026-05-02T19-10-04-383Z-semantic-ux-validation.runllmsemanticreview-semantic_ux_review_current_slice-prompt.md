...
- provider: openai
- model: gpt-5.4
- started_utc: 2026-05-02T19:10:04.383Z
- prompt_chars: 65777
- prompt_estimated_tokens: 16445
- prompt_sources:
  ...
  return (
    <main className="app-shell">
      <section className="panel hero">
        ...
        <h1>Your complete preventive care plan</h1>
        <p className="lede">
          Review every recommended care step in one place, then open any item for details and completion.
        </p>
        <div className="actions">
...
export function HealthItemDetailAndCompletionPage({ profile, onRestart }) {
  ...
  useEffect(() => {
    ...
    if (globalThis.location.hash.startsWith('#/health-item/')) {
      globalThis.history.replaceState(null, '', isFromPlanRoute ? '#/plan' : '#/dashboard');
    }
