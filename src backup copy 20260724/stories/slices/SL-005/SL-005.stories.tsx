...
import RouteSurface1 from '../../../routes/family-onboarding-and-family-overview.jsx';
...
export const HealthScoreCardVisual = {
  render: () => <ComponentSurface3 score={78} highlightedItem={{
...
export const PrioritySectionVisual = {
  render: () => <ComponentSurface4 priority="today" title="Today" items={[{
...
export const StatusPillVisual = {
  render: () => <ComponentSurface6 status="due" label="Due now" />,
  name: 'Product/StatusPill',
};

export const FamilyProfileCardVisual = {
  render: () => <ComponentSurface7 name="Alex" score={78} dueCount={3} />,
  name: 'Product/FamilyProfileCard',
};

export const VaccinationStatusRowVisual = {
  render: () => <ComponentSurface8 vaccine="Influenza vaccine" status="planned" statusLabel="Planned" lastDate={null} />,
