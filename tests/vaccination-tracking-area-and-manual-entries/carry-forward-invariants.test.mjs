...
test('[SL-001] dashboard keeps Today/Soon/Later sections, highlighted item, and health score', () => {
  const projection = buildDashboardProjection(createSnapshot(), createProfile());
