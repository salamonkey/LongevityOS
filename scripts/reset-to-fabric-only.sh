...
echo "  2) ./fabric/company/v1/fabric pm:intake --target ."
echo "  3) ./fabric/company/v1/fabric pm:brief-readiness --target ."
echo "  4) ./fabric/company/v1/fabric pm:brief-draft --target ."
echo "  5) ./fabric/company/v1/fabric pm:brief-approve --target ."
echo "  6) ./fabric/company/v1/fabric pm:derive-values --target ."
echo "  7) ./fabric/company/v1/fabric format-from-brief --target ."
echo
