# Codex work order: implement SL-004 Vaccination Tracking Area and Manual Entries
...
- `docs/ux/SL-004-interaction-model.json`
- `docs/ux/SL-004-screen-contract.json`
- `docs/ux/SL-004-component-contract.json`
- `docs/ux/SL-004-copy-contract.json`
...
Required regression evidence file: `tests/vaccination-tracking-area-and-manual-entries/carry-forward-invariants.test.mjs`
...
- src/routes/vaccination-tracking-area-and-manual-entries.js
- tests/vaccination-tracking-area-and-manual-entries/**
